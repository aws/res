    ...
    * Additional components for eVDI functionality.
    ...
    def build_cluster_settings(self):
        cluster_settings = {
            ...
            'dcv_host_instance_profile_name': self.dcv_host_scoped_down_instance_profile.ref,
            'dcv_host_instance_profile_arn': self.build_instance_profile_arn(self.dcv_host_scoped_down_instance_profile.ref),
