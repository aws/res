...
"""
Serializer for Project - handles conversion between API model and DDB dict.
...
Available fields: project_id, name, description, title
"""
...
class ProjectSerializer(BaseSerializer):
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for Project.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for Project.
