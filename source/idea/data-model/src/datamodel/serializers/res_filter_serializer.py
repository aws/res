...
"""
Serializer for ResFilter - handles conversion between API model and DDB dict.
...
Available fields: key, value, eq, _in, like, starts_with, ends_with, _and, _or
"""
...
class ResFilterSerializer(BaseSerializer):
    """
    Serializer for ResFilter model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for ResFilter.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for ResFilter.
...
resfilter_serializer = ResFilterSerializer()
