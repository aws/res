...
"""
Serializer for ResDateRange - handles conversion between API model and DDB dict.
...
Available fields: key, start, end
"""
...
class ResDateRangeSerializer(BaseSerializer):
    """
    Serializer for ResDateRange model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for ResDateRange.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for ResDateRange.
...
resdaterange_serializer = ResDateRangeSerializer()
