...
Available fields: monday, tuesday, wednesday, thursday, friday, saturday, sunday
"""
...
class VirtualDesktopWeekScheduleSerializer(BaseSerializer):
    """
    Serializer for VirtualDesktopWeekSchedule model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for VirtualDesktopWeekSchedule.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for VirtualDesktopWeekSchedule.
