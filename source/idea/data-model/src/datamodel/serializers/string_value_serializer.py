...
"""
Serializer for StringValue - handles conversion between API model and DDB dict.
...
class StringValueSerializer(BaseSerializer):
    """
    Serializer for StringValue model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for StringValue.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for StringValue.
...
stringvalue_serializer = StringValueSerializer()
