...
"""
Serializer for VirtualDesktopPermission - handles conversion between API model and DDB dict.
...
Available fields: key, name, description, enabled
"""
...
class VirtualDesktopPermissionSerializer(BaseSerializer):
    """
    Serializer for VirtualDesktopPermission model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for VirtualDesktopPermission.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for VirtualDesktopPermission.
...
virtualdesktoppermission_serializer = VirtualDesktopPermissionSerializer()
