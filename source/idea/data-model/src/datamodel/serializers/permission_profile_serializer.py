...
"""
Serializer for PermissionProfile - handles conversion between API model and DDB dict.
...
class PermissionProfileSerializer(BaseSerializer):
    """
    Serializer for PermissionProfile model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for PermissionProfile.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for PermissionProfile.
...
permissionprofile_serializer = PermissionProfileSerializer()
