...
"""
Serializer for Script - handles conversion between API model and DDB dict.
...
Available fields: script_location, arguments
"""
...
class ScriptSerializer(BaseSerializer):
    """
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for Script.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for Script.
