...
"""
Serializer for VirtualDesktopSessionConnection - handles conversion between API model and DDB dict.
...
Available fields: idea_session_id, idea_session_owner, endpoint, web_url_path, access_token, failure_reason
"""
...
class VirtualDesktopSessionConnectionSerializer(BaseSerializer):
    """
    Serializer for VirtualDesktopSessionConnection model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for VirtualDesktopSessionConnection.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for VirtualDesktopSessionConnection.
...
virtualdesktopsessionconnection_serializer = VirtualDesktopSessionConnectionSerializer()
