...
"""
Serializer for ScriptEvents - handles conversion between API model and DDB dict.
...
Available fields: on_vdi_start, on_vdi_configured, rerun_on_reboot
"""
...
class ScriptEventsSerializer(BaseSerializer):
    """
    Serializer for ScriptEvents model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for ScriptEvents.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for ScriptEvents.
...
scriptevents_serializer = ScriptEventsSerializer()
