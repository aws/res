...
"""
Serializer for VirtualDesktopPlacement - handles conversion between API model and DDB dict.
...
Available fields: affinity, tenancy, host_id, host_resource_group_arn
"""
...
class VirtualDesktopPlacementSerializer(BaseSerializer):
    """
    Serializer for VirtualDesktopPlacement model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for VirtualDesktopPlacement.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for VirtualDesktopPlacement.
...
virtualdesktopplacement_serializer = VirtualDesktopPlacementSerializer()
