...
"""
Serializer for ListValue - handles conversion between API model and DDB dict.
...
class ListValueSerializer(BaseSerializer):
    """
    Serializer for ListValue model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for ListValue.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for ListValue.
...
listvalue_serializer = ListValueSerializer()
