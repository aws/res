...
"""
Serializer for Budget - handles conversion between API model and DDB dict.
...
class BudgetSerializer(BaseSerializer):
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for Budget.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for Budget.
