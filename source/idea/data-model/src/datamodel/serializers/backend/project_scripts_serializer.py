...
"""
Serializer for ProjectScripts - handles conversion between API model and DDB dict.
...
Available fields: linux, windows
"""
...
class ProjectScriptsSerializer(BaseSerializer):
    """
    Serializer for ProjectScripts model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for ProjectScripts.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for ProjectScripts.
...
projectscripts_serializer = ProjectScriptsSerializer()
