...
"""
Serializer for ResFilterValueStringOrList - handles conversion between API model and DDB dict.
...
Available fields: string_value, list_value
"""
...
class ResFilterValueStringOrListSerializer(BaseSerializer):
    """
    Serializer for ResFilterValueStringOrList model.
    ...
    def _customize_to_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom API -> DDB transformations for ResFilterValueStringOrList.
    ...
    def _customize_from_ddb(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Add custom DDB -> API transformations for ResFilterValueStringOrList.
...
resfiltervaluestringorlist_serializer = ResFilterValueStringOrListSerializer()
