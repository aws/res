...
from api.exceptions import BadRequestException, InternalServiceException, NotFoundException
...
class RESAsyncApp(connexion.AsyncApp):  # type: ignore[misc]
    ...
    async def _handle_lambda_exception(
        request: ConnexionRequest, exception: Union[BadRequestException, InternalServiceException, NotFoundException]
    ) -> ConnexionResponse:
