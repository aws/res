...
def configure_environment(context: ideavirtualdesktopcontroller.AppContext):
    ...
    os.environ["private_hosted_zone_name"] = cluster_settings.get_setting("cluster.route53.private_hosted_zone_name") or ""
