...
class VirtualDesktopEventType(str, Enum):
    ...
    VALIDATE_DCV_SESSION_READY_EVENT = 'VALIDATE_DCV_SESSION_READY_EVENT'
    ...
    DELETE_LOCK_FILES_LINUX_COMMAND_PROGRESS_EVENT = 'DELETE_LOCK_FILES_LINUX_COMMAND_PROGRESS_EVENT'
