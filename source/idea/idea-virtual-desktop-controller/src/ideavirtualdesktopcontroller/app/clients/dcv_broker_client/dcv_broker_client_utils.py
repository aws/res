...
class DCVBrokerClientUtils:
    ...
    def get_storage_root_for_base_os(base_os: VirtualDesktopBaseOS, owner) -> str:
        if base_os in (VirtualDesktopBaseOS.AMAZON_LINUX2, VirtualDesktopBaseOS.AMAZON_LINUX2023, VirtualDesktopBaseOS.RHEL8, VirtualDesktopBaseOS.RHEL9, VirtualDesktopBaseOS.UBUNTU2204, VirtualDesktopBaseOS.UBUNTU2404, VirtualDesktopBaseOS.ROCKY_LINUX9):
