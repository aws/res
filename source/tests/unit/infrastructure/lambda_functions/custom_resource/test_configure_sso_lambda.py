...
from idea.infrastructure.resources.lambda_functions.custom_resource.configure_sso_lambda.configure_sso_handler import (
...
USER_POOL_ID = "dummy_user_pool"
CLUSTER_NAME = "dummy_cluster_name"
SECRET_ARN = "secret-arn"
LOAD_BALANCER_DNS = "load-balancer-dns"
CUSTOM_TAG_KEY = "dummy_key"
CUSTOM_TAG_VALUE = "dummy_key"
CUSTOM_TAGS = [f"Key={CUSTOM_TAG_KEY},Value={CUSTOM_TAG_VALUE}"]
...
class MockClusterConfigDB:
    ...
    def __init__(self):
        self.items = {
            ...
            "global-settings.custom_tags": CUSTOM_TAGS,
        }
...
def test_create_or_update_identity_provider_invalid_provider_name(
    ...
    with pytest.raises(Exception) as exc_info:
        sso_helper.create_or_update_identity_provider(saml_payload)
        assert SSO_SOURCE_PROVIDER_NAME_ERROR_MESSAGE == str(exc_info)
