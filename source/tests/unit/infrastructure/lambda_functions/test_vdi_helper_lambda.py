...
from idea.infrastructure.resources.lambda_functions_with_utils.vdi_helper_lambda.auth import (
    get_instance_id_from_user_arn,
    get_source_ip_from_request_context,
    validate_instance_origin,
)
from idea.infrastructure.resources.lambda_functions_with_utils.vdi_helper_lambda.handler import (
    handle_vdi_auto_stop,
)
