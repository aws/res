...
from tests.lambdas.util import get_api_response, get_api_response_data
...
@pytest.fixture
def list_mounts_url_path() -> str:
    return f"/awsproxy/{os.environ.get('REGION')}/elasticfilesystem/2015-02-01/mount-targets?FileSystemId={os.environ.get('FILE_SYSTEM_ID')}"
