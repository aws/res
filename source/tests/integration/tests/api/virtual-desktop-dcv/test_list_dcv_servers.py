...
"""
Integration tests for List DCV Servers API.

This module contains comprehensive tests for the list DCV servers REST API
...
class TestListDCVServers:
    """Test suite for the list DCV servers endpoint."""

    @pytest.mark.parametrize("admin_username", ["clusteradmin"])
    def test_list_dcv_servers_returns_valid_response(
        self,
        ...
        """
        Test successful retrieval of DCV servers.
        """
        try:
            ...
            logger.info(f"Successfully retrieved DCV servers response")

        except Exception as e:
            pytest.fail(f"Unexpected API error: {str(e)}")

    @pytest.mark.parametrize("non_admin_username", ["user1"])
    def test_list_dcv_servers_with_non_admin_user_returns_authorization_error(
        self,
        request: FixtureRequest,
        region: str,
        res_environment: ResEnvironment,
    ...
    def test_list_dcv_servers_with_nonexistent_user_returns_user_not_found_error(
    ...
    def test_list_dcv_servers_with_inactive_user_returns_inactive_user_error(
        self,
        request: FixtureRequest,
        region: str,
        res_environment: ResEnvironment,
    ...
    def test_list_dcv_servers_without_auth_token_returns_no_authorization_token_provided_error(
        self,
        request: FixtureRequest,
        region: str,
        res_environment: ResEnvironment,
    ...
    @pytest.mark.parametrize("admin_username", ["clusteradmin"])
    def test_list_dcv_servers_in_prod_with_invalid_auth_token_returns_unable_to_retrieve_username_error(
        self,
        request: FixtureRequest,
        region: str,
        res_environment: ResEnvironment,
    ...
    @pytest.mark.parametrize("admin_username", ["clusteradmin"])
    def test_list_dcv_servers_with_invalid_next_token_returns_error(
        self,
        request: FixtureRequest,
        region: str,
        res_environment: ResEnvironment,
        ...
        try:
            ...
            api_client.list_dcv_servers(next_token="invalid_token_12345")
