...
- Instances with NVME instance store don't become unresponsive post-restart due to file system checks enforcement
...
- Users can now specify DEPLOYMENT_TYPE for their FSX for Lustre file systems
